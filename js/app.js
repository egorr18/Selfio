(function () {
    ...
    function weeklyPage() {
        ...
        for (let i = 0; i < 7; i++) {
            ...
            dayPcts.push(dayScore);
            weekdayScores.push({ name: names[i], score: dayScore });
      ...
      `;
        ...
        if (weekLinesEl) {
            ...
            lines.push(`Tip: <b>${weekScore >= 70 ? "Keep momentum" : "Make it smaller"}</b> — 1 focused block daily.`);
            ...
            if (!isPremium()) {
                ...
                for (const key of Object.keys(state.days)) {
                    ...
                    if (dt.getFullYear() === thisYear && dt.getMonth() === thisMonth) {
                        ...
                        const wname = names[(dt.getDay() + 6) % 7]; // map to Mon..Sun
                        if (weekdayAgg[wname]) {
